...
select * from leadspeek_invoices where leadspeek_api_id = '81151983' order by id desc;

select * from leadspeek_reports lr where leadspeek_api_id = '81151983' and lr.created_at >= '2025-11-24 03:41:17';

-- 2025-11-24 03:41:17

select * from leadspeek_reports where leadspeek_api_id = '33445017' order by clickdate desc;


select leadspeek_invoices.created_at from leadspeek_invoices
...
where
	...
	leadspeek_users.leadspeek_type = 'enhance' and 
...
WHERE leadspeek_users.archived = 'F'
  ...
  AND leadspeek_users.leadspeek_type = 'enhance'

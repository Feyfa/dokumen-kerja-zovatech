...
class WattData 
{
     ...
     * @return array
     */
    public function get_resolve_identities(array $data, $leadspeek_api_id = null, $leadspeek_type = null)
    {
     ...
     * @return array
     */
    public function get_person(array $person_ids, $leadspeek_api_id = null, $leadspeek_type = null, $domains = ['id', 'email', 'name', 'phone', 'address'])
    {
        // $startTime = microtime(true);
        try
        {
    ...
    */
     ...
     * @param  bool        $isAdvanced         Jika true, ambil basic + advanced fields. Jika false, hanya basic fields
     * @return array       Person info array jika ditemukan, empty array [] jika tidak
     */
    public function getWattPersonInfo(array $identifiers, $leadspeek_api_id = null, $leadspeek_type = null, $isAdvanced = false)
    {
        ...
        $upsertErrorReportAnalytics = function() use ($context, $leadspeek_api_id, $leadspeek_type){
            if($context === 'md5'){
        ...
        if($isAdvanced){
            $requestDomains = array_merge($requestDomains, ['demographic', 'financial', 'household', 'lifestyle', 'interest', 'content', 'purchase']);
        }

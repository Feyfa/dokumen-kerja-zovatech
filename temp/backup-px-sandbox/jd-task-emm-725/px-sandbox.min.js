var PxGrabber = {
	...
	fetch: async function(callback) {
		...
		// xhr.open("GET", "https://api.emmsandbox.com/pixel?label=" + this.options.Label + "&script=true"); // previous
		// xhr.open("GET", `http://apilocal.emmsandbox.com/pixel?${paramsString}`); // local
		xhr.open("GET", `https://api.emmsandbox.com/pixel?${paramsString}`); // production
